...
void SQLExecutor::blob(int bigSize)
{
    ...
    try
    {
        *_pSession << "INSERT INTO Person VALUES (?,?,?,?)", use(lastName), use(firstName), use(address), use(img), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.displayText() << std::endl;
    ...
    try
    {
        *_pSession << "INSERT INTO Person VALUES(?,?,?,?)", use(lastName), use(firstName), use(address), use(big), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.displayText() << std::endl;
...
void SQLExecutor::doNull()
{
    ...
    *_pSession << "INSERT INTO Vectors VALUES (null, null, null)", now;
    ...
    try
    {
        *_pSession << "SELECT COUNT(*) FROM Vectors", into(count), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.displayText() << std::endl;
