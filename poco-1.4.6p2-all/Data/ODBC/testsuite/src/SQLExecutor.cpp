...
void SQLExecutor::simpleAccess()
{
    ...
    try
    {
        *_pSession << "INSERT INTO Person VALUES (?,?,?,?)", use(lastName), use(firstName), use(address), use(age), now;
    }
...
void SQLExecutor::complexType()
{
    ...
    try
    {
        *_pSession << "INSERT INTO Person VALUES (?,?,?,?)", use(p1), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
    ...
    try
    {
        *_pSession << "INSERT INTO Person VALUES (?,?,?,?)", use(p2), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
    ...
    try
    {
        *_pSession << "SELECT * FROM Person WHERE LastName = 'LN1'", into(c1), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
...
void SQLExecutor::complexTypeTuple()
{
    ...
    try
    {
        *_pSession << "INSERT INTO PERSON VALUES(?,?,?,?,?,?,?,?)", use(t), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
    ...
    try
    {
        *_pSession << "SELECT * FROM PERSON", into(ret), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
...
void SQLExecutor::simpleAccessVector()
{
    ...
    try
    {
        *_pSession << "INSERT INTO Person VALUES (?,?,?,?)", use(lastNames), use(firstNames), use(addresses), use(ages), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
    ...
    try
    {
        *_pSession << "SELECT * FROM Person", into(lastNamesR), into(firstNamesR), into(addressesR), into(agesR), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
...
void SQLExecutor::complexTypeVector()
{
    ...
    try
    {
        *_pSession << "SELECT * FROM Person", into(result), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
...
void SQLExecutor::insertVector()
{
...

    {
        ...
        try
        {
            *_pSession << "SELECT COUNT(*) FROM Strings", into(count), now;
        }
        catch(ConnectionException& ce)
        {
            std::cout << ce.toString() << std::endl;
...
void SQLExecutor::insertSingleBulk()
{
    ...
    try
    {
        *_pSession << "SELECT SUM(str) FROM Strings", into(count), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
...
void SQLExecutor::bools()
{
    ...
    try
    {
        *_pSession << "INSERT INTO Strings VALUES (?)", use(data), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
    ...
    try
    {
        *_pSession << "SELECT str FROM Strings", into(ret), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
...
void SQLExecutor::limits()
{
    ...
    try
    {
        *_pSession << "SELECT * FROM Strings", into(retData), limit(50), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
...
void SQLExecutor::limitZero()
{
    ...
    try
    {
        *_pSession << "SELECT * FROM Strings", into(retData), limit(0), now;    // stupid test, but at least we shouldn't crash
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
...
void SQLExecutor::selectIntoSingle()
{
    ...
    try
    {
        *_pSession << "SELECT * FROM Person", into(result), limit(1), now;    // will return 1 object into one single result
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
...
void SQLExecutor::selectIntoSingleFail()
{
    ...
    try
    {
        *_pSession << "SELECT COUNT(*) FROM Person", into(count), limit(2, true), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
...
void SQLExecutor::combinedLimits()
{
    ...
    try
    {
        *_pSession << "SELECT * FROM Person", into(result), lowerLimit(2), upperLimit(2), now;    // will return 2 objects
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
...
void SQLExecutor::ranges()
{
    ...
    try
    {
        *_pSession << "SELECT * FROM Person", into(result), range(2, 2), now;    // will return 2 objects
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
...
void SQLExecutor::blob(int bigSize, const std::string& blobPlaceholder)
{
    ...
    try
    {
        *_pSession << format("INSERT INTO Person VALUES (?,?,?,%s)", blobPlaceholder), use(lastName), use(firstName), use(address), use(img), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
    ...
    try
    {
        *_pSession << "SELECT Image FROM Person", into(res), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
    ...
    try
    {
        *_pSession << "DELETE FROM Person", now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
    ...
    try
    {
        *_pSession << format("INSERT INTO Person VALUES (?,?,?,%s)", blobPlaceholder), use(lastName), use(firstName), use(address), use(big), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
...
void SQLExecutor::tuples()
{
    ...
    try
    {
        *_pSession << "INSERT INTO Tuples VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", use(t), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
    ...
    try
    {
        *_pSession << "SELECT * FROM Tuples", into(ret), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
...
void SQLExecutor::tupleVector()
{
    ...
    try
    {
        *_pSession << "INSERT INTO Tuples VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", use(v), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
    ...
    try
    {
        *_pSession << "SELECT COUNT(*) FROM Tuples", into(count), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
...
void SQLExecutor::internalExtraction()
{
    ...
    try
    {
        *_pSession << "INSERT INTO Vectors VALUES (?,?,?)", use(v), now;
    }
    catch(ConnectionException& ce)
    {
        std::cout << ce.toString() << std::endl;
    ...
    try
    {
        ...
        try
        {
            const Column<int>& col1 = rset.column<int>(100);
            fail ("must fail");
        }
